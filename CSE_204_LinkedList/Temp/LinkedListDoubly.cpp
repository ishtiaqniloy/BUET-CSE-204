...
int main(void)
{
    initializeList();
    while(1){
        printf("1. Insert First.  2. Search item. \n");
        printf("3. Delete item.   4. Delete After.   5. Delete Last. \n");
        printf("6. Print forward. 7. Print backward. 8. exit.\n");
